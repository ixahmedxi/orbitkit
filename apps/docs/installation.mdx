...
bun set:namespace -n "@myapp" --ir
# When including the root package, the root package will be renamed to "myapp"

# Set the author for all the packages
bun set:author -a "Your Name <[email protected]> - https://yourwebsite.com" --ir

# Set the license for all the packages to MIT
bun set:license -l "MIT" --ir
```
