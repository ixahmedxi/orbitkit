...
> Note: If you want to pass special characters in the author flag, you should wrap the value in two sets of quotes `'""'` e.g. `'"Ahmed <ahmed@orbitkit.dev> - https://orbitkit.dev"'`.
